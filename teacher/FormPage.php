...
<div class="m-scene" id="main">
    <div class="m-aside scene_element scene_element--fadein">
        ...
        <div class="container">
            <div class="jumbotron text-center"><h1 style="font-family: Damion; font-size:5em;"><a style="color:inherit"
                                                                                                  href="/index.php">Quizify!
                </h1>
                <h4>
            ...
            <div class="jumbotron">
                <h1 class="text-center" style="font-family: Damion;">Submit a question</h1>
                <hr>
                <div class="form-group">
                    <form name="qForm" action="SubmitQuestion.php" method="POST">
                        ...
                        <br>
                        <p>Enter Wrong Answers (at least one)</p>
                        ...
                        <br><br>
                        <button class="btn btn-success form-control" type="submit" onclick="return checkInputs()">
                            Submit
                        </button>
                    </form>
